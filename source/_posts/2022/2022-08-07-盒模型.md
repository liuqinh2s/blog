...
在线演示：[父子元素外边距合并](https://codepen.io/liuqinh2s/pen/myRjmjM)

<iframe height="400" style="width: 100%;" scrolling="no" title="示例Pen" src="https://codepen.io/liuqinh2s/embed/myRjmjM" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
</iframe>
