...
优先队列一般是用堆来实现的，查询复杂度是O(1)，插入和删除的复杂度是O(logN)。堆结构就是一个完全二叉树，完全二叉树可以用数组实现。

测试场景：[215. 数组中的第K个最大元素](https://leetcode.cn/problems/kth-largest-element-in-an-array/description/)
...
测试场景2：[2034. 股票价格波动](https://leetcode.cn/problems/stock-price-fluctuation/description/)
