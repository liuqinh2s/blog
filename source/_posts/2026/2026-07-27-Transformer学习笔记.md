...
1. 现代 GPT 大模型采用的是 Pre-LN，而非论文中提到的 Post-LN，二者有非常大的差别
2. 现代 GPT 大模型采用的是RMSNorm，抛弃了减均值环节，因为发现减均值带来的增益几乎为0
...
1. 神经网络用到大量数学工具，最常用的工具：矩阵，激活函数，归一化函数。
2. 大模型的架构没有多复杂，全靠一个大字，堆叠几十层结构重复的网络。